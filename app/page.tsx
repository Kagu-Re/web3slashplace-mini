            ...
            <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-8 min-w-0 flex-1">
              ...
              <div className="hidden lg:flex items-center space-x-4 xl:space-x-6">
                <button 
                  ...
                  className="text-xs xl:text-sm text-gray-600 hover:text-gray-900 transition-colors whitespace-nowrap"
                >
                  About & Info
                </button>
                <a 
            ...
            <div className="space-y-2">
              <button
                onClick={() => {
                  ...
                  setTimeout(() => setAboutModalOpen(true), 100);
                }}
              ...
              >
                ...
                <span className="text-gray-700">About & Info</span>
              </button>
